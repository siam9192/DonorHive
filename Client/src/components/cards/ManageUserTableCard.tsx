  ...
  return (
    <tr className="odd:bg-white  even:bg-gray-50  border-b  border-gray-200">
      ...
      <td className="px-6 py-4">
        <p className="p-2 bg-blue-50 w-fit text-blue-700 rounded-full">{user.provider.replace("-"," ")}</p>
      </td>
      <td className="px-6 py-4">
        <div className="flex items-center gap-1">
          <div className={`size-2 rounded-full ${user.status === EUserStatus.Active ? 'bg-primary':'bg-red-500'} `}></div>
