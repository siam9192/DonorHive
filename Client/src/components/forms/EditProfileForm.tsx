...
const EditProfileForm = () => {
  return (
   ...
   <img src="https://cdn-icons-png.flaticon.com/512/3001/3001758.png" alt="" className='size-32 rounded-full '  />
  ...
  <input defaultValue='John Doe' className='px-2 py-3 font-medium bg-green-50  w-full'/>
