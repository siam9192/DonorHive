...
const DonationDetails = ({closePopup,enableManageButtons,id}:IProps) => {
  ...
  return (
    <div>  <h1 className="text-2xl font-medium text-gray-800">Donation Details</h1>
    <div className="mt-8">
      <div>
      ...
      <div className="mt-4">
        ...
        <div className="mt-3 space-y-3 font-secondary">
          ...
          <p className=" font-medium space-x-2 md:text-[1rem] text-sm">
            <span className="text-gray-950 font-semibold">Created At:</span>
            <span>
              {new Date(donation.payment.createdAt).toDateString()}-{new Date(donation.payment.createdAt).toLocaleTimeString()}
            </span>
          </p>
          <p className=" font-medium space-x-2 md:text-[1rem] text-sm">
            <span className="text-gray-950 font-semibold">Updated At:</span>
            <span>
              {new Date(donation.payment.updatedAt).toDateString()}-{new Date(donation.payment.updatedAt).toLocaleTimeString()}
            </span>
          </p>
        </div>
      </div>
